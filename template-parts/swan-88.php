<?php
/* Template Name: swan 88 */
get_header(); ?>

<style type="text/css">
	.page-template-swan-88 section.spec-sec-excss .spec-sec-ex {
		background: #0c2169;
		padding: 60px 70px;
		border-radius: 145px;
	}
	...
	@media (max-width: 1440px) {
		.page-template-swan-88 section.interior-main-sec .container-fluid .interior-img-are .img-ovr-cont {
			height: 265px;
		}
	}
	...
	@media (max-width: 1243px) {
		.page-template-swan-88 .page-template-EXCESS11 section.interior-main-sec .container-fluid .interior-img-are .img-ovr-cont p {
			font-size: 17px;
	...
	@media (max-width:992px) {
		.page-template-swan-88 .page-template-EXCESS14 .page-template-EXCESS11 section.spec-sec-excss .spec-sec-ex .spec-box .spec-line ul li {
			margin-bottom: 0px;
		}

		.page-template-swan-88 section.bann-btm-sec .row-in>div {
			width: 100%;
			margin: 0 auto;
		}
	}
	...
	@media (max-width:768px) {
		...
		.page-template-swan-88 .page-template-EXCESS11 section.interior-main-sec .container-fluid .interior-img-are .img-ovr-cont {
			padding: 60px 30px;
		}
	...
	@media (max-width: 767px) {
		...
		.page-template-swan-88 .spec-box:after {
			position: absolute;
			content: '';
		...
		.page-template-swan-88 section.spec-sec-excss .spec-sec-ex .spec-box:nth-child(3):after {
			position: relative;
		}
		.page-template-swan-88 .page-template-EXCESS11 .download-the-brochure {
		    padding: 0 30px;
		}
	...
	@media (max-width: 390px){
		.page-template-swan-88 .download-the-brochure {
		    padding: 0 0px !important;
		}
	}
	@media (max-width: 320px){
		.page-template-swan-88 .download-the-brochure a {
								...
								<div class="spec-box">
									...
									<div class="spec-line">
										<ul>
											...
											<?php endforeach; ?>
											<?php
											if ($spec_box['heading_top'] == 'DIMENSIONS') {

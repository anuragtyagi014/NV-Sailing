<?php
   /* 
   Template Name: Tiwal 3R Template
   */
...
<style>
   .page-template-tiwal-3R .bann-btm-right {
       width: 360px;
       margin-top: -140px;
   }
   .page-template-tiwal-3R .intirior-in-img {
        background: #fff0;
    }
   .page-template-tiwal-3R section.top-bann-sec img {
       width: 100%;
       height: auto;
       object-fit: cover;
       object-position: center;
   }
   .page-template-tiwal-3R .interior-img-are {
        margin-top: 50px;
    }
    .page-template-tiwal-3R section.spec-sec-excss .spec-sec-ex .spec-box .spec-line ul li {
        font-weight: 600;
    }
...
.container-fluid {
    ...
    <?php endif; endwhile; endif; ?>
    <?php
    if (have_rows('sailing_area')):
        while (have_rows('sailing_area')): the_row();
            if (get_row_layout() == 'add_row'):
    ?>
        ...
        <section class="interior-main-sec">
                <div class="container-fluid">
                    <div class="sec-head" data-aos="zoom-in">
                        ...
                        <h2 class="tagline"><?php echo get_sub_field('sub_heading'); ?></h2>
                            <?php echo get_sub_field('content'); ?>
                    </div>
                    <div class="interior-img-are" data-aos="zoom-in">
                        <div class="intirior-in-img">
                            <img src="<?php echo get_sub_field('desktop_image'); ?>" class="twile_desktop">
                            <img src="<?php echo get_sub_field('mobile_image'); ?>" class="twile_mobile">
                        </div>
                    </div>
                </div>
        </section>
    <?php endif; endwhile; endif; ?>
    <?php
    if (have_rows('ergonomics_area')):
        while (have_rows('ergonomics_area')): the_row();
            if (get_row_layout() == 'add_row'):
    ?>
        <section class="interior-main-sec">
                <div class="container-fluid">
    ...
    <?php endif; endwhile; endif; ?>
    <?php
    if (have_rows('transport_area')):
        while (have_rows('transport_area')): the_row();
            if (get_row_layout() == 'add_row'):
    ?>
        <section class="interior-main-sec">
                <div class="container-fluid">
    ...
    <?php endif; endwhile; endif; ?>
    <?php
    if (have_rows('assembly_area')):
        while (have_rows('assembly_area')): the_row();
            if (get_row_layout() == 'add_row'):
    ?>
        <section class="interior-main-sec">
                <div class="container-fluid">
    ...
    <?php endif; endwhile; endif; ?>
    <?php
    if (have_rows('design_area')):
        while (have_rows('design_area')): the_row();
            if (get_row_layout() == 'add_row'):
    ?>
        <section class="interior-main-sec">
                <div class="container-fluid">
    ...
    <?php endif; endwhile; endif; ?>
    <?php
    if (have_rows('the_boat_area')):
        while (have_rows('the_boat_area')): the_row();
            if (get_row_layout() == 'add_row'):
    ?>
        <section class="interior-main-sec">
                <div class="container-fluid">
              ...
              <div class="spec-box">
                 <div class="spec-line">
                    <ul>
                        <div class="row">
                            <div class="col-md-6">
                                <?php $countle=1; foreach(get_sub_field('left_list') as $left_list): ?>
                                   <li <?php if(($countle == 1) || ($countle == 4)){ echo 'style="border-bottom: 2px solid #ffffff03"'; } ?>><span><?php echo $left_list['title']; ?> </span> <?php echo $left_list['value']; ?></li>
                                <?php $countle++; endforeach; ?>
                            </div>
                            <div class="col-md-6">
                                <?php foreach(get_sub_field('right_list') as $right_list): ?>
                                   <li><span><?php echo $right_list['title']; ?> </span> <?php echo $right_list['value']; ?></li>
                                <?php endforeach; ?>
                            </div>
    ...
    <?php
    if (have_rows('tiwal_3r_sails_area')):
        while (have_rows('tiwal_3r_sails_area')): the_row();
            if (get_row_layout() == 'add_row'):
    ?>
        <section class="interior-main-sec">
                <div class="container-fluid">
                    ...
                    <div class="interior-img-are" data-aos="zoom-in">
                        ...
                        <div class="last_main">
                             <h4><?php echo get_sub_field('last_content'); ?></h4>
                        </div>
                    </div>
                </div>
        </section>
